...
const LoginWithGoogle = ({handleGoogleLogin}) => {
    ...
    return (
        <button onClick={handleGoogleLogin} className="btn bg-white dark:bg-gray-800 dark:text-gray-200 dark:border-gray-800 w-full hover:scale-105 text-black text-base border-[#e5e5e5] transition-all duration-200">
